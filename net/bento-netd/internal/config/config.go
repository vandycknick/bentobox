...
func Parse(args []string) (*Config, error) {
	var listenVfkit, subnet, pidFile, logFile, pcapFile, vmID, networkID, profileName, policyFile, auditLog, secretStoreFile, tlsCACert, tlsCAKey string
	var sshPort int
